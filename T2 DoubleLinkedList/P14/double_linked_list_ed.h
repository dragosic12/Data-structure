...
protected:
    ...
    //El nodo fantasma es el que apunta al inicio y al final. Solo apunta al primero
    //Se podria llamar prim en vez de fantasma
    //El nodo fantasma no tiene valor
    Nodo * fantasma;
...
protected:
    ...
    Nodo * inserta_elem(T const& e, Nodo * anterior, Nodo * siguiente) {
        ...
        //Hay que tener cuidado con el orden. Hay que eliminar primero el anterior
        anterior->sig = nuevo;
        siguiente->ant = nuevo;
        return nuevo;
    }
