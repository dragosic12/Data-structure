...
public:
    ...
    void intercambio(linked_list_ed_plus<T>& l1, linked_list_ed_plus<T>& l2, Nodo & n) {
        l1.prim = l2.prim;
        n = l2.prim;
        l1.ult = n->sig;
        l2.prim = l2.prim->sig;
    ...
    void inserta(Nodo & n, linked_list_ed_plus<T>& l1, linked_list_ed_plus<T>& l2) {
        n->sig = l1.prim;
        l2.ult = n->sig;
        l1.prim = l1.prim->sig;
